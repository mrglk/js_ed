...
const getHeroes = () => {
    ...
    for (i = 0; i < heroes.length; i++) {
        createHero(heroes[i]);
        // localStorage.getItem(heroes[i].name, heroes[i].value)
    }
}
...
const createHero = (data) => {
    ...
    input.addEventListener('input', function() {
        ...
        heroesRating.push(vote);
        // localStorage.setItem(data.name, input.value)
        localStorage.setItem("heroesRating", JSON.stringify(heroesRating))
    });
